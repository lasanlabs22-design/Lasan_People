...
import { useConsumeSearchParam } from "@/components/navigation";
  ...
  if (state?.ok) {
    return (
      <div className="space-y-4">
        <CredentialsCard name={state.employee.name} loginId={state.employee.employeeCode} password={state.tempPassword} />
